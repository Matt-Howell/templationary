...
export default function TemplatePage({ data, templateID }) {
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`https://templationary.com/templates/${templateID}`}/>
        ...
        <meta property="twitter:url" content={`https://templationary.com/templates/${templateID}`}/>
        ...
        <link rel="canonical" href={`https://templationary.com/templates/${templateID}`}/>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://templationary.com/templates/${templateID}"
          },
          "headline": "${data.title}",
                ...
                <Flex justifyContent={"start"} width="100%" flexDirection={{ base:"column", md:"row" }} maxWidth={"1392px"}>
                    <Flex flexDirection={"column"} justifyContent={"start"} width={{ base:"100%", md:"70%" }} px={{ base:"none", md:4 }}>
                        <Breadcrumb spacing='8px' separator={<FaChevronRight size={12} opacity='0.8' color='gray.500' />}>
                            <BreadcrumbItem>
                                <BreadcrumbLink href='/templates/' _hover={{ textDecoration:"none", opacity:0.9 }} opacity={0.8}>Templates</BreadcrumbLink>
                            </BreadcrumbItem>
                        ...
                        <Link _hover={{ textDecoration:"none" }} href={`/get/templates/${templateID}`}><Button width={"100%"} mt={5} mb={2} size="lg" colorScheme={'blue'} rightIcon={<FaArrowRight />}>
                            Get This Template
                        </Button></Link>
                        <Heading 
                        as="h3"
